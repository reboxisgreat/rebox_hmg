...
[각 Step별 코칭 가이드]
Step 1: "세 키워드 중 지금 당신 조직에서 가장 아쉬운 부분과 연결되는 것은?"
Step 2: "구성원들이 주도적으로 움직이지 않는다면, 조직 구조나 문화에서 그 원인을 찾는다면 무엇인가요?"
Step 3: "2028년 말, 구성원들이 실장님을 어떻게 표현하면 좋겠나요?"
Step 4: "이번 주 안에 실행할 수 있는 가장 의미 있는 첫 번째 행동은 무엇인가요?"
`
}
...
[각 Step별 코칭 가이드]
Step 1: "이 키워드들이 지금 당신 조직의 어떤 구조적 문제를 건드렸나요?"
Step 2: "조직 전체 관점에서, 가장 낭비라고 느끼는 회의·보고·의사결정 구조가 있다면 무엇인가요?"
Step 3: "2028년 말, 당신 조직의 회의와 의사결정 방식은 어떻게 달라져 있을까요?"
Step 4: "당장 다음 주에 조직 차원에서 없애거나 단순화할 수 있는 프로세스는?"
`
}
